...
public class ListEventsForm extends Form {
    ...
    public Form createForm() {
        ...
        Label labelLibelle = new Label("name");
        Label labelQtEvent = new Label("desc");
        Label labelPrix = new Label("date");
        Label labelrate = new Label("participant");
...
//                 e -> new HomeReview());
        ...
        ArrayList<Event> Events = ServiceEvent.getInstance().afiichageEvent();
        for (Event r : Events) {
            //delete button
            ...
            lSupprimer.addPointerPressedListener(l -> {
                ...
                if (ServiceEvent.getInstance().deleteEvent(r)) {
...
// 
        ...
        Button Comment = new Button("ajouter Event");
        Comment.addActionListener(e -> new AddEventForm());
        tempForm.show();

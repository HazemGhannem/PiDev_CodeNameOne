 ...
 * @author Matoussi
 */
public class TabQuestionForm extends BaseForm{

    Form current;
    Resources res;

    public TabQuestionForm(Form previous) {
    ...
    public Form createForm() {
        ...
        SpanLabel labelt = new SpanLabel("Question");
        SpanLabel labeldesc = new SpanLabel("Theme");
        ...
        ArrayList<Question> themes = ServiceQuestion.getInstance().affichageQuestion();
        for (Question t : themes) {
            //delete button
...
//            });
            ...
            BodyConainter.add(new Label(t.getLibelle()));
//            String description = String.valueOf(t.getId_themetest());
